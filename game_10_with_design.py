...
def receive_sword():
    print_sword()
    # Receive special sword, opening up special options
    print("A sword forms into existence in front of you.")
    print("You reach out and take it. It feels comfortable in your hands.")
    print("You sense a dreadful glee from Cthulhu, and you feel a strange force push you from the room.")
    global got_sword
    got_sword = True
    start_adventure()
...
def guard():
    ...
    while True:
        if not got_sword:
            ...
            next_action = input("[run | door | sword] > ").lower()
        ...
        if next_action == "run" and guard_moved:
            ...
            you_died("Guard was faster than he looks and your world goes dark...")
        elif next_action == "sword" and got_sword:
            print("You raise the sword given to you by Cthulhu.")
            print("You can feel the guard's soul being ripped from his body, being absorbed into the weapon.")
            print("You hear a deep cackling within your heart as the guard's soulless body falls to the floor.")
            print("The treasure is yours and the way out is clear.")
            return
        else:
...
def painful_truth_of_reality_room():
    ...
    if "flee" in next_move:
        start_adventure()
    # Worship the great evil Cthulhu for a special surprise
    elif "worship" in next_move:
        print("You drop to your knees and praise his tentacle-yness, the ancient one, Cthulhu.")
        print("Cthulhu seems pleased at your fervor. He bestows upon you a special gift.")
        receive_sword()
    else:
...
def start_adventure():
    ...
    if door_picked == "red":
        if not got_sword:
            ...
            print("The sword in your hands becomes unbearably hot as you approach the red door.")
            print("You take the blue door instead.")
...
def print_sword():
    ...
    print("OOOOO||_________________________>")
    print("     ||")
    print("     ==")
    print()
